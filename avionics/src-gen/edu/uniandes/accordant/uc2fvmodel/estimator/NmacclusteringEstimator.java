...
public class NmacclusteringEstimator {

	public static void main(String[] args) throws Exception {

		//TODO add master params code from dv
		SparkConf conf = new SparkConf().setAppName("NmacclusteringEstimator")
						.setMaster("local[*]");
		
		JavaSparkContext sc = new JavaSparkContext(conf);
		SparkSession sparkSession = new SparkSession(sc.sc());
		InputStream pmmlFile = new URL("file:////Users/kmilo/Documents/Desarrollo/pmml-models/NMACKmeans.pmml")
						.openStream();
		...
		fields.add(DataTypes.createStructField("x1", DataTypes.DoubleType, true));
		fields.add(DataTypes.createStructField("x2", DataTypes.DoubleType, true));
		fields.add(DataTypes.createStructField("x3", DataTypes.DoubleType, true));
		fields.add(DataTypes.createStructField("x4", DataTypes.DoubleType, true));
